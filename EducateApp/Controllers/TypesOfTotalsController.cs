...
namespace EducateApp.Controllers
{
    ...
    public class TypesOfTotalsController : Controller
    {
        ...
        // GET: TypesOfTotals
        public async Task<IActionResult> Index(TypesOfTotalsSortState sortOrder = TypesOfTotalsSortState.CertificateNameAsc)
        {
            ...
            ViewData["CertificateNameSort"] = sortOrder == TypesOfTotalsSortState.CertificateNameAsc ? TypesOfTotalsSortState.CertificateNameDesc : TypesOfTotalsSortState.CertificateNameAsc;

            typeOfTotal = sortOrder switch
            {
                TypesOfTotalsSortState.CertificateNameDesc => typeOfTotal.OrderByDescending(s => s.CertificateName),
